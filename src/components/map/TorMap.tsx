...
export default function TorMap() {
  ...
  // WebGL availability (Tor Browser has WebGL2 disabled by default)
  ...
  // Tor Browser disables WebGL2 by default for fingerprinting protection
  useEffect(() => {
    try {
      const canvas = document.createElement('canvas');
      if (canvas.getContext('webgl2')) return; // WebGL2 available, no error
      
      // WebGL2 unavailable - check if WebGL1 works to provide better guidance
      setWebglError(canvas.getContext('webgl') ? 'WEBGL2_DISABLED' : 'WEBGL_DISABLED');
    } catch {
  ...
  if (webglError) {
    const isWebGL2Only = webglError === 'WEBGL2_DISABLED';
        ...
        <div className="text-center max-w-md px-4">
          ...
          <div className="text-gray-500 text-xs space-y-2 text-left bg-black/30 rounded-lg p-4">
            ...
            {!isWebGL2Only && (
              <>
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-400 mb-4">
                  <li>Click the <strong>shield icon</strong> 🛡️ in the toolbar</li>
                  <li>Select <strong>&quot;Standard&quot;</strong> security level</li>
                  <li>Refresh this page</li>
                </ol>
                <p className="font-medium text-gray-300 mb-2">Option 2: Enable WebGL manually</p>
                <ol className="list-decimal list-inside space-y-1 text-gray-400 mb-4">
                  <li>Type <code className={codeStyle}>about:config</code> in the address bar</li>
                  <li>Search for <code className={codeStyle}>webgl.disabled</code> and set to <code className="text-tor-green">false</code></li>
                </ol>
              </>
            )}
            ...
            <ol className="list-decimal list-inside space-y-1.5 text-gray-400">
              ...
              <li>Search: <code className={codeStyle}>webgl.enable-webgl2</code></li>
              <li>Click toggle (↔️) to set to <code className="text-tor-green">true</code></li>
              <li>Refresh this page</li>
            </ol>
            
            <div className="mt-4 pt-3 border-t border-gray-700">
              <p className="text-gray-500">
                <strong className="text-gray-400">Privacy note:</strong> Enabling WebGL may allow some fingerprinting.
              </p>
            </div>
          </div>
        </div>
