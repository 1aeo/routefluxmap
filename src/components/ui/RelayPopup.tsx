      ...
      <div className="flex justify-between items-start p-4 border-b border-tor-green/20">
        <div>
          <h3 className="text-tor-green font-bold text-lg">
            {node.relays.length === 1 ? node.relays[0].nickname : `${node.relays.length} Relays`}
          </h3>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span 
                  ...
                  style={{ 
                    color: relayType.color,
                    backgroundColor: `${relayType.color}20`
                  }}
                >
                  {relayType.name}
                </span>
                {hsDir && (
                  <span className="text-[10px] text-purple-400 bg-purple-400/20 px-1 py-0.5 rounded">
                    HSDir
                  </span>
                )}
              </div>
